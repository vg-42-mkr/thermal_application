...
Runs continuously for a configurable duration (default: 60 seconds), cycling through
...
def main() -> int:
    ...
    ap.add_argument(
        "--csv",
        type=Path,
        default=Path(__file__).parent.parent / "tests" / "csv_data" / "thermal_data_base.csv",
        help="Path to input CSV file (default: tests/csv_data/thermal_data_base.csv)",
     )
